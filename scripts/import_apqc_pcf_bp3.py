...
TREE["BP-110"] = {
    ...
    "children": [
        {
            "id": "BP-110.10", "apqc": "11.1",
            "name": "Manage Enterprise Risk",
            "description": "Identify, assess, treat, and monitor enterprise risk across financial, operational, strategic, and compliance dimensions.",
            "realizes": ["BC-120", "BC-140"],
            "children": [
                ("BP-110.10.10", "11.1.1", "Establish Enterprise Risk Framework",
                 "Establish the enterprise risk-management framework, taxonomy, and governance.",
                 ["BC-120", "BC-110"]),
                ("BP-110.10.20", "11.1.2", "Manage Business Unit and Function Risk",
                 "Identify and manage risks at business-unit and functional levels.",
                 ["BC-120"]),
                ("BP-110.10.30", "11.1.3", "Manage Process Risk",
                 "Identify and manage risks at the process level.",
                 ["BC-120", "BC-930"]),
            ],
        },
        {
            "id": "BP-110.20", "apqc": "11.2",
            "name": "Manage Business Resiliency",
            "description": "Maintain business-continuity and disaster-recovery capabilities; respond to and recover from disruptive events.",
            "realizes": ["BC-160"],
            "children": [
                ("BP-110.20.10", "11.2.1", "Develop Business Resiliency Plan",
                 "Develop business-continuity and disaster-recovery plans for critical processes and assets.",
                 ["BC-160"]),
                ("BP-110.20.20", "11.2.2", "Test the Plan",
                 "Exercise resiliency plans through tests and drills.",
                 ["BC-160"]),
                ("BP-110.20.30", "11.2.3", "Manage and Execute Business Resiliency Response",
                 "Activate and execute resiliency responses during disruptive events.",
                 ["BC-160"]),
            ],
        },
        {
            "id": "BP-110.30", "apqc": "11.3",
            "name": "Manage Environmental, Health, and Safety (EHS)",
            "description": "Run EHS programs that protect employees, communities, and the environment, including incident response and regulatory reporting.",
            "realizes": ["BC-730", "BC-740"],
            "children": [
                ("BP-110.30.10", "11.3.1", "Manage EHS Strategy",
                 "Set EHS strategy, policy, and target performance.",
                 ["BC-730"]),
                ("BP-110.30.20", "11.3.2", "Manage EHS Implementation",
                 "Implement EHS programs across operations.",
                 ["BC-730"]),
                ("BP-110.30.30", "11.3.3", "Train Employees on EHS",
                 "Deliver EHS training to employees and contractors.",
                 ["BC-730", "BC-300"]),
                ("BP-110.30.40", "11.3.4", "Monitor and Manage EHS Performance",
                 "Monitor EHS performance, incidents, and lagging/leading indicators.",
                 ["BC-730", "BC-720"]),
                ("BP-110.30.50", "11.3.5", "Remediate Environmental Issues",
                 "Remediate environmental issues and contamination, including legacy liabilities.",
                 ["BC-730", "BC-740"]),
            ],
        },
    ],
...
TREE["BP-120"] = {
    ...
    "children": [
        {
            "id": "BP-120.10", "apqc": "12.1",
            "name": "Build Investor Relationships",
            "description": "Engage with current and prospective investors, analysts, and rating agencies; manage investor communications and disclosures.",
            "realizes": ["BC-240"],
            "children": [
                ("BP-120.10.10", "12.1.1", "Plan, Build, and Manage Investor Relations",
                 "Establish and run the investor-relations program.",
                 ["BC-240"]),
                ("BP-120.10.20", "12.1.2", "Communicate with Investors",
                 "Communicate financial results, strategy, and outlook to investors.",
                 ["BC-240", "BC-850"]),
            ],
        },
        {
            "id": "BP-120.20", "apqc": "12.2",
            "name": "Manage Government and Industry Relationships",
            "description": "Engage with regulators, government bodies, and industry associations on policy, lobbying, and regulatory matters.",
            "realizes": ["BC-150", "BC-850"],
            "children": [
                ("BP-120.20.10", "12.2.1", "Manage Government Relations",
                 "Engage with government bodies on policy and regulatory matters.",
                 ["BC-150", "BC-850"]),
                ("BP-120.20.20", "12.2.2", "Manage Industry Relations",
                 "Engage with industry associations and standard-setting bodies.",
                 ["BC-850"]),
            ],
        },
        {
            "id": "BP-120.30", "apqc": "12.3",
            "name": "Manage Relations with Board of Directors",
            "description": "Support the board: agendas, materials, governance processes, and director engagement.",
            "realizes": ["BC-110", "BC-240"],
            "children": [
                ("BP-120.30.10", "12.3.1", "Report Results to the Board",
                 "Prepare and present financial and operational results to the board.",
                 ["BC-110", "BC-240"]),
                ("BP-120.30.20", "12.3.2", "Report Audit Findings to the Board",
                 "Report internal-audit findings and remediation status to the audit committee.",
                 ["BC-140", "BC-110"]),
            ],
        },
        {
            "id": "BP-120.40", "apqc": "12.4",
            "name": "Manage Legal and Ethical Issues",
            "description": "Manage legal matters, contracts, litigation, ethics programs, and corporate-conduct standards.",
            "realizes": ["BC-150", "BC-130"],
            "children": [
                ("BP-120.40.10", "12.4.1", "Create Ethics and Business Conduct Policies",
                 "Establish and maintain ethics and conduct policies.",
                 ["BC-130", "BC-150"]),
                ("BP-120.40.20", "12.4.2", "Manage Corporate Governance Compliance",
                 "Manage compliance with corporate-governance and disclosure obligations.",
                 ["BC-110", "BC-130"]),
                ("BP-120.40.30", "12.4.3", "Manage Legal Issues",
                 "Manage litigation, disputes, and legal exposures.",
                 ["BC-150"]),
                ("BP-120.40.40", "12.4.4", "Manage Compliance with Laws/Regulations",
                 "Run regulatory-compliance programs across jurisdictions.",
                 ["BC-130", "BC-150"]),
                ("BP-120.40.50", "12.4.5", "Provide Legal Counsel and Advice",
                 "Provide legal counsel to the business across day-to-day decisions.",
                 ["BC-150"]),
                ("BP-120.40.60", "12.4.6", "Negotiate and Document Agreements/Contracts",
                 "Negotiate, draft, and manage commercial contracts and agreements.",
                 ["BC-150", "BC-510"]),
            ],
        },
        {
            "id": "BP-120.50", "apqc": "12.5",
            "name": "Manage Public Relations Program",
            "description": "Run external communications, media relations, brand reputation, and crisis communications.",
            "realizes": ["BC-850"],
            "children": [
                ("BP-120.50.10", "12.5.1", "Manage Community Relations",
                 "Engage with local communities where the enterprise operates.",
                 ["BC-850", "BC-740"]),
                ("BP-120.50.20", "12.5.2", "Manage Media Relations",
                 "Manage relations with media, including press communications and crisis comms.",
                 ["BC-850"]),
                ("BP-120.50.30", "12.5.3", "Promote Political Stability",
                 "Engage on political-stability and regulatory-environment matters where relevant.",
                 ["BC-850", "BC-150"]),
                ("BP-120.50.40", "12.5.4", "Build/Sustain Corporate Image",
                 "Build and sustain the corporate brand and reputation.",
                 ["BC-850", "BC-400"]),
            ],
        },
    ],
